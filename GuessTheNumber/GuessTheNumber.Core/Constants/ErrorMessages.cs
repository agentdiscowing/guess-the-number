namespace GuessTheNumber.Core.Constants
{
    public static class ErrorMessages
    {
        ...
        public const string GuessTheNumberNoActiveGameException = "There is no active game right now";

        public const string GuessTheNumberOwnerAttemptException = "Making attempt on one's own game is not allowed";
    }
}